      ...
      <div className="absolute bottom-0 w-full flex items-center justify-between px-8 py-4">
        <div>
          <button
            ...
            className="px-2 py-2 bg-red-700 text-white font-bold rounded-full  hover:opacity-75 duration-300 ease-out"
          >
            Close
          </button>
        </div>
        <div className="flex items-center gap-8 text-white font-bold">
          ...
          <button className="px-2 py-2 bg-logoBlue text-white font-bold rounded-full  hover:opacity-75 duration-300 ease-out">
            Order
          </button>
        </div>
      </div>
